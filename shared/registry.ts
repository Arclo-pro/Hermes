...
export const METRIC_KEYS = {
  ...
  'gsc.coverage_percent': { label: 'Index Coverage', unit: 'percent', source: 'gsc' },
  'gsc.indexed_pages': { label: 'Indexed Pages', unit: 'count', source: 'gsc' },
  'gsc.indexing_errors': { label: 'Indexing Errors', unit: 'count', source: 'gsc' },
  'gsc.robots_blocked': { label: 'Robots-Blocked Pages', unit: 'count', source: 'gsc' },
  'gsc.crawl_errors': { label: 'Crawl Errors', unit: 'count', source: 'gsc' },
  'gsc.robots_txt_valid': { label: 'Robots.txt Valid', unit: 'boolean', source: 'gsc' },
...
export const SERVICES: Record<string, ServiceDefinition> = {
  google_data_connector: {
    ...
    metricsProduced: [
      ...
      'gsc.coverage_percent', 'gsc.indexed_pages', 'gsc.indexing_errors',
      'gsc.robots_blocked', 'gsc.crawl_errors', 'gsc.robots_txt_valid',
    ],
  ...
  serp_intel: {
    ...
    description: 'Maintains a prioritized keyword set, tracks ranking position and movement over time, and feeds downstream agents with accurate search visibility context',
  ...
  technical_seo: {
    ...
    description: 'Crawl & indexing monitor: ensures the site is crawlable, indexable, and structurally clear to search engines',
    metricsProduced: [
      'tech.pages_crawled', 'tech.errors', 'tech.warnings', 'tech.blocked_urls',
      'technicalHealthScore', 'indexCoverage',
    ],
